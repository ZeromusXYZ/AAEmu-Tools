...
public partial class aaemu_game_context : DbContext
{
    ...
    public virtual DbSet<IcsMenu> IcsMenus { get; set; }

    public virtual DbSet<IcsShopItem> IcsShopItems { get; set; }

    public virtual DbSet<IcsSku> IcsSkus { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=127.0.0.1;database=aaemu_game;uid=aaemu;pwd=aaadmin", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.12-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IcsShopItem>(entity =>
        {
        ...
        modelBuilder.Entity<IcsSku>(entity =>
        {
