...
namespace AAPacker
{
    ...
    public class AAPakFileHeader
    {
        ...
        /// </summary>
        public readonly MemoryStream FAT = new MemoryStream();
        ...
        public void ReadFileTable()
        {
            ...
            for (uint i = 0; i < totalFileCount; i++)
            {
                ...
                using (var ms = new MemoryStream(bufSize))
                {
                    ...
                    if ((_owner.PakType == PakFileType.TypeA) || (_owner.PakType == PakFileType.TypeF) || (_owner.PakType == PakFileType.TypeA))
                    {
